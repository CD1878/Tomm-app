...
export default function DashboardLayout({
    ...
    return (
        <div className="flex h-dvh bg-white overflow-hidden selection:bg-[#253551]/20">
            {/* Sidebar */}
            <motion.aside
                initial={{ x: -20, opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.4, ease: "easeOut" }}
                className="w-64 border-r border-[#253551]/10 bg-white/50 backdrop-blur-xl flex flex-col z-20"
            >
            ...
            <main className="flex-1 relative overflow-y-auto w-full bg-slate-50/50">
                ...
                <motion.div
                    ...
                    className="relative z-10 p-8 md:p-12 max-w-7xl mx-auto"
                >
                    {children}
                </motion.div>
            </main>
